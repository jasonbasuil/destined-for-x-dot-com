      ...
      <Container>
        ...
        <Faq
          items={[
            ...
            {
              question: "What if I already applied for the 2020 in-person program?",
              answer:
            ...
            {
              question: "But I was so excited to travel & stay in Silicon Valley for the trip!",
              answer: "We totally get it! We're super bummed too. But putting on a virtual program this year in lieu of the COVID-19 crisis is better than no program. And it's at no expense for all students."
            },
            {
              question: "But students from previous years got to go to so many cool companies and meet new people!",
              answer: "And this year's virtual program you still get to meet cool people from top companies as well as meet other ambitious students who are wanting to improve their leadership skills this summer! In addition, all students who join us and complete the Virtual program this year will be eligible to receive Destined for X apparel, potential scholarships, mentorship opportunities, and more!"
            },
            {
              question: "Will there be an in-person program next year?",
              answer: "We are planning to host an in-person program in 2021, so you can always submit an application next year."
            },
            {
              question: "What is the best way to contact Destined for X if I have more questions?",
              answer:
